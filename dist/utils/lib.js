...
export const failure = (data = '') => ({ error: true, data });
export const success = (data = '') => ({
    error: false,
    data,
});
export const setKeychainValue = async ({ key = '', value = '', } = {}) => {
...
export const getKeychainValue = async ({ key = '', } = {}) => {
    return new Promise(async (resolve) => {
        try {
...
export const resetKeychainValue = async ({ key = '', } = {}) => {
    return new Promise(async (resolve) => {
        try {
 ...
 */
export const nap = (ms = 500) => new Promise((resolve) => setTimeout(resolve, ms));
